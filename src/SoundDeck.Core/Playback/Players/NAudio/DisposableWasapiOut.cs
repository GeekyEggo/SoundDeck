...
namespace NAudio.Wave
{
    ...
    /// <remarks>
    /// <para>
    ///     This is a direct copy-implementation of WasapiOut, with IDisposable implemented correctly.
    /// </para>
    /// <para>
    ///     https://raw.githubusercontent.com/naudio/NAudio/fb35ce8367f30b8bc5ea84e7d2529e172cf4c381/NAudio.Wasapi/WasapiOut.cs
    /// </para>
    /// </remarks>
    public class DisposableWasapiOut : IWavePlayer, IWavePosition
    {
        private static readonly int AUDCLNT_E_BUFFER_SIZE_NOT_ALIGNED = HResult.MAKE_HRESULT(1, 0x889, 0x019);
        ...
        public DisposableWasapiOut(AudioClientShareMode shareMode, int latency) :
        ...
        /// <param name="latency">Desired latency in milliseconds</param>
        public DisposableWasapiOut(AudioClientShareMode shareMode, bool useEventSync, int latency) :
        ...
        /// <param name="useEventSync">true if sync is done with event. false use sleep.</param>
        /// <param name="latency">Desired latency in milliseconds</param>
        public DisposableWasapiOut(MMDevice device, AudioClientShareMode shareMode, bool useEventSync, int latency)
        {
            ...
            if (isUsingEventSync)
            {
                ...
                else
                {
                    ...
                    catch (COMException ex)
                    {
                        ...
                        if (ex.ErrorCode != AUDCLNT_E_BUFFER_SIZE_NOT_ALIGNED)
                            throw;
