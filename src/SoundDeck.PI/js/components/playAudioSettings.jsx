    ...
    render() {
        return (
            <PropertyInspectorWrapper>
                ...
                <FilesPicker label="Files" valuePath="files" accept="audio/aiff,audio/x-aiff,audio/mpeg,audio/ogg,audio/wav" buttonLabel="Add file..." enableSort={this.state.enableSort} />
            </PropertyInspectorWrapper>
        );
    }
}
