...
- App Media Controls <sup>+</sup>
- Set App Audio Device
- Set App Volume
- Set Default Audio Device
- Set Audio Device Volume <sup>+</sup>
- Sampler
- Clear Sampler
- Clip Audio
- Stop Audio
...
<sup>+</sup> Includes support for Stream Deck+.
